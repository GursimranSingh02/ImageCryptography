...
def encrypt_image(image_path, key_file, encrypted_path):
    # Open image
...
def decrypt_image(encrypted_img_file, key_file, decrypted_path):
...
# Generating a random key and stores in the file
